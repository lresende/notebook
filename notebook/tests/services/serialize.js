...
casper.notebook_test(function () {
    ...
    this.then(function () {
        var success = this.evaluate(function () {
            ...
            EchoBuffers.prototype.on_msg = function (msg) {
                Jupyter._msgs.push(msg);
                this.comm.send(msg.content.data, {}, {}, msg.buffers);
            };

            Jupyter.notebook.kernel.comm_manager.register_target("echo", function (comm) {
    ...
    this.then(function () {
        var index = this.append_cell([
            "import os",
            "from Jupyter.kernel.comm import Comm",
    ...
    this.then(function () {
        ...
        var buf_info = function (message, index) {
            var buf = Jupyter._msgs[message].buffers[index];
            var data = {};
